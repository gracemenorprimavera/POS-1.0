							...
							for (var i = 0; i < temp.length; i++){
	    						...
	    						if(mode == "custDSearch"){
	    							...
	    							output = output + '<td>' + value + '</td>';
										...
										output = output + "<td><input type='hidden' name='customer_id' value='7'><input type='text' name='customerCash'/></td><td><input type='submit' value='Pay' class='button' required/></td></tr>";
										if(temp2.length>0){
